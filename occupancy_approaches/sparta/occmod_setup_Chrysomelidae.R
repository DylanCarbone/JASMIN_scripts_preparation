...
setwd("/gws/ssde/j25b/ceh_generic/dylcar/indicators_2025/Chrysomelidae_Sp")

# Format hoverfly data - remove already completed species
data = read.csv("Data_CHR.csv") %>%
...
saveRDS(visitData, "Chrysomelidae_Sp_filtered_start_years.rds")
