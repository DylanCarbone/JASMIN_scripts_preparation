...
setwd("/gws/ssde/j25b/ceh_generic/dylcar/indicators_2025/RoveBeetles_Sp")

# Format RoveBeetles data - remove already completed species
data = read.csv("Data_ROV.csv") %>%
...
saveRDS(visitData, "RoveBeetles_Sp_filtered_start_years.rds")
