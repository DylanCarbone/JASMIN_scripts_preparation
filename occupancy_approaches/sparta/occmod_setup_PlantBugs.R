...
setwd("/gws/ssde/j25b/ceh_generic/dylcar/indicators_2025/PlantBugs_Sp")

# Format PlantBugs data - remove already completed species
data = read.csv("Data_PLA.csv") %>%
...
saveRDS(visitData, "PlantBugs_Sp_filtered_start_years.rds")
